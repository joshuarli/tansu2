---
title: "Nvidia is Raking in the Money, but are Earnings Inflated?"
date: "2021-05-27T18:17:34.846Z"
url: "https://newsletter.semianalysis.com/p/nvidia-is-raking-in-the-money-but"
author: "Dylan Patel"
description: "Nvidia has beat earnings expectations yet again on the backs of datacenter and gaming lines."
---
...
Investors and fans must recognize this when looking at the current records. They also must commend Nvidia for this master prowess in supply chain. They quickly reacted to surging crypto demand and increased production of their last generation Turing GPUs in order to generate huge amounts of profit. These GPUs still manufactured by TSMC, rather than Samsung like the current generation, which means gaming GPU sales are not hampered. The $655M of GPU sales in the first half of this year are almost purely additive. Furthermore, in previous crypto mining crashes, GPUs were turned around and sold in the used gaming market destroying demand for new GPUs. These CMP GPUs cannot be repurposed for gaming and will not hurt future demand.
...
Nvidia GPU sales could be inflated because of mining, but at the same time, the market is not satisfied. Only about 15% of the market has RTX enabled GPUs. The percentage of GPU ownership that owns RTX enabled GPUs could be much higher. Gaming is growing at an incredible pace, and even if crypto sales fall off, the demand from gamers will take some time to satiate. Many people want a new GPU, but they simply cannot get one. Nvidia says they expect gaming GPU sales to grow every quarter this year. This mean GeForce will easily become a $3B a quarter business. Despite all the process technology criticisms, this level of business would have been impossible to achieve if Nvidia went with TSMC for their new generation of GPUs.
