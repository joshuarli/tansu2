...
date: "2025-08-13T00:27:14.000Z"
url: "https://newsletter.semianalysis.com/p/gpt-5-ad-monetization-and-the-superapp"
author: "Doug"
...
On [OpenAI’s release website](https://openai.com/index/introducing-gpt-5/), the second paragraph is about the “One United System,” specifically focused on the **router**. The wording is instructive.
...
Centralizing the control of the free user experience allows for many more future monetization paths. And this monetization path is one that has been hinted at subtly for a while. It all starts with OpenAI’s decision to [hire Fidji Simo as CEO of Applications in May](https://openai.com/index/leadership-expansion-with-fidji-simo/). Let’s look at her background because it’s telling.
...
And while this feels like speculation, this is already happening. [Instacart added this feature to let agents checkout](https://www.instacart.com/company/updates/ordering-groceries-with-an-ai-agent-like-openais-operator/) products in January of this year. Fidji Simo was at Instacart when this was implemented, and now she just joined OpenAI as head of product. The wheels are already in motion, this will be the future of free usage at ChatGPT.
...
Finance Companies: [Stripe](https://openai.com/index/stripe/), [Visa](https://usa.visa.com/about-visa/newsroom/press-releases.releaseId.21361.html), [PayPal](https://community.openai.com/t/payment-option-paypal/27423)

Consumer Companies: [Mattel](https://corporate.mattel.com/news/mattel-and-openai-announce-strategic-collaboration), [Booking.com](https://openai.com/index/booking-com/), [Lowe’s](https://openai.com/index/lowes/)

Enterprise Software: [Salesforce](https://openai.com/index/salesforce/), [Intercom](https://openai.com/index/intercom/), [Zendesk](https://openai.com/index/zendesk/)

Consumer Internet: [Snapchat](https://community.openai.com/t/snapchat-is-releasing-its-own-ai-chatbot-powered-by-chatgpt/77051), [Shopify](https://www.retailtouchpoints.com/topics/digital-commerce/openai-shopify-reportedly-working-on-chatgpt-checkout-integration), [Instacart](https://www.instacart.com/company/updates/ordering-groceries-with-an-ai-agent-like-openais-operator/), [Mercari](https://openai.com/index/mercari/)
