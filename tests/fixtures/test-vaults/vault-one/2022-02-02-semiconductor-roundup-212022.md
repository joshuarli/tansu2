...
date: "2022-02-02T07:46:35.754Z"
url: "https://newsletter.semianalysis.com/p/semiconductor-roundup-212022"
author: "Dylan Patel"
description: "AMD, NXP, Google, KLIC, Cirrus Logic, Entegris, SK Hynix, Lasertec, Rohm, Fabrinet"
---

This will be our third post of this type for the flurry of semiconductor earnings releases and calls that are happening now. [In the first post](https://semianalysis.substack.com/p/semiconductor-roundup-1272022), we covered Teradyne, Lam Research, Wolfspeed, Texas Instruments, UMC, Intel, Xilinx, Samsung, and MediaTek. [In the second post](https://semianalysis.substack.com/p/semiconductor-roundup-1282022), we covered Tesla, Apple, KLAC, MKS Instruments, MACOM Technologies, Silicon Motion, and STMicroelectronics. These are almost required reading because the most interesting parts of these roundup posts are what you can read through about other firms in the supply chain that sometimes are seemingly even unrelated. Some themes in the previous post will continue on, but others will not. In this post, we cover Google, NXPI, Kulicke and Soffa Industries, Cirrus Logic, Entegris, AMD, SK Hynix, Rohm, and Fabrinet.
