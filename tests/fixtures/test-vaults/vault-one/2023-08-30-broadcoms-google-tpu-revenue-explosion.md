...
date: "2023-08-30T21:16:07.758Z"
url: "https://newsletter.semianalysis.com/p/broadcoms-google-tpu-revenue-explosion"
author: "Dylan Patel"
description: "Broadcom: The Silent Giant in AI Chip Revolution - Putting Numbers To It"
---
...
Often overlooked is that Broadcom is the second largest AI chip company in the world in terms of revenue behind NVIDIA, with multiple billions of dollars of accelerator sales. This is primarily driven by [Google’s aggressive TPU ramp](https://www.semianalysis.com/p/google-gemini-eats-the-world-gemini) as part of its self-described “ [Code Red](https://www.semianalysis.com/p/google-gemini-eats-the-world-gemini) ” in response to the Microsoft + OpenAI alliance that is challenging Google’s world leadership in AI.
...
Google isn’t the only one of course. [Meta also makes their in-house AI chips with Broadcom](https://www.semianalysis.com/p/meta-custom-silicon-whats-old-is), but Meta doesn’t deploy too many of these… yet. Aside from a massive TPU ramp which we will detail further below, there are numerous positive developments taking place within Broadcom. This includes their other custom silicon products with firms like Meta, their world leading networking business, [which is the 2 <sup>nd</sup> largest spending bucket for a AI infrastructure after accelerators](https://www.semianalysis.com/p/nvidias-optical-ascent-1b-revenue), continued strength in wireless chips despite weak smartphone sales due to Apple content growth, and the upcoming VMWare integration. There’s a lot here, as this is one of the more financial number focused reports we’ve put out.
...
Broadcom’s story starts with HP’s semiconductor division. Since the birth of the semiconductor industry up until the 80s and 90s, most hardware companies were vertically integrated with their semiconductor divisions and foundries. HP was no different. Buried inside HP was its test and instrumentation segment which itself contained an internal chip division focused on RF components such as filters as well as passive components such as resistors and capacitors. The diamond in the rough was RF filters, a device that allows [an antenna to tune](https://www.semianalysis.com/p/ayar-labs-co-packaged-optics-revolution) into a specific frequency band while filtering out all the unwanted radio signals on other bands.
...
Broadcom’s custom silicon ramp is the real focus for today. [Most people don’t realize the magnitude of it.](https://www.semianalysis.com/p/google-gemini-eats-the-world-gemini) Today we will put dollars out the door to Google and in the door to Broadcom. Furthermore we will go through the rest of their networking growth and the accretion model from VMWare as well.
