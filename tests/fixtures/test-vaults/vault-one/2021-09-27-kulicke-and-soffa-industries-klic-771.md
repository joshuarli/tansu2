---
title: "Kulicke & Soffa Industries, $KLIC, Continued Outperformance Of Wire Bonders And Emerging Supplier in Mini-LED, Micro-LED, And Battery Manufacturing"
date: "2021-09-27T21:02:20.676Z"
url: "https://newsletter.semianalysis.com/p/kulicke-and-soffa-industries-klic-771"
author: "Dylan Patel"
description: "SemiAnalysis has been bullish about Kulicke and Soffa Industries since late 2020 on back channels with projections/models."
---
...
A small anecdote is that Tesla has even been a top 10 customer for them in the past. If you watched Tesla’s battery day, it looks like one of the process steps is KNS proprietary ribbon bonding for their cylindrical batteries. As Tesla and their other major customers across Europe and Asia ramp, this will drive KNS sales. Furthermore, they are expanding into prismatic battery solutions and enhancing their cylindrical battery systems.

Tesla and Rivian use cylindrical for their vehicles, but most other automakers are pushing for prismatic and pouch style cells. Tesla has a variety of reasons for using cylindrical cells, primarily related to pack level engineering. While cylindrical cells are more expensive per kWh alone, the final assembly cost per kWh is more important. The pack must house all the batteries while retaining structural rigidity and housing an advanced thermal management and charging architecture.
...
Furthermore, the core wire bonder business is not sitting still. KNS is being ultra conservative as usual and signaling flat to negative growth. This seems ridiculous given the amount of trailing edge capacity going online which was referenced earlier, trends in packaging/test intensity, and the eventual normalization of utilization rates. SemiAnalysis expects this business to grow slightly from the current run rate in 2022 be flat in 2023. We project utilization rates will reach the 85% to 90% range in late 2023. If semiconductors continue to grow beyond 6.5% CAGR though, we are in for outsized growth in this business.

SemiAnalysis expects $KLIC to achieve $6.1 EPS in 2021 and $7 EPS in 2022 and 2023. KNS currently has roughly 10% of their market cap in cash and no long-term debt, so it is ripe for capital return. The management team is tame on explicit announcing anything here, but they will have an incredible amount of long-term cash generation and no real outlet for disposing it beside buybacks and dividends.
