...
ASML’s “Twinscan” architecture enables reading many marks over the entire wafer surface, because 1 wafer stage can do metrology while the 2 <sup>nd</sup> does actual exposures. Canon’s NIL architecture has a single stage, so it must either do very little metrology or do it at the same time as exposure to maintain good throughput.
