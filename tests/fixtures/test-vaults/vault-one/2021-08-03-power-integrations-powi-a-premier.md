---
title: "Power Integrations, $POWI, A Premier ESG Play Semiconductor Exposure To Electric Vehicles, Green Energy, And Power Efficiency Regulations"
date: "2021-08-03T03:00:36.253Z"
url: "https://newsletter.semianalysis.com/p/power-integrations-powi-a-premier"
author: "Dylan Patel"
description: "Power Integrations is major supplier for power related semiconductors."
---
...
> We also won a 130-watt design for a leading supplier of gaming notebooks, featuring four charging ports and using three GaN-based InnoSwitches.

Laptop bricks from gaming laptops have notoriously been large and unwieldy, but with GaN, these can be reduced in size and include more ports. Razr ships a similar but lower power and less featured solution based on previous generation technology. We believe this win is related to Asus.

> Anker's next generation Nano II chargers which comes in 30, 45 and 65-watt versions. Notably the 65-watt version is approximately the same size as the 30-watt chargers from the first generation of Nano chargers. This improved power density is enabled by our latest product InnoSwitch4 which will be produced exclusively with GaN.

Even generation to generation, Anker's former GaN charger has more than doubled in power output with the same size due to Power Integration’s technology innovation.
