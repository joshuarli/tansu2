---
title: "GlobalFoundries $GFS IPO – Mubadala Lost Over $22.4B, Now They Are Hoping Public Markets Bail Them Out"
date: "2021-10-06T13:03:32.152Z"
url: "https://newsletter.semianalysis.com/p/globalfoundries-gfs-ipo-mubadala"
author: "Dylan Patel"
description: "In 2008, Mubadala, the Abu Dhabi government owned sovereign wealth fund assisted AMD in divesting their manufacturing assets and spinning them off."
---
...
That wasn’t the only element that pushed them to make the first gross profit in years though. Depreciation of fabrication equipment was extended which reduces cost of revenues to a large degree. The change was from 5 or 8 years to 10 years of useful life. This is a major factor to consider when noticing that GlobalFoundries went from negative gross margin to positive gross margin.
...
In total, GlobalFoundries received $1.5B, the East Fishkill fab which is being sold for $430M, the ASIC unit which is being sold for $650M to Marvell, and a treasure trove of IP related to RF, high performance SOI technologies, and silicon photonics. To SemiAnalysis, it seems they made off like bandits while forcing IBM to have to find a new partner in Samsung for future designs.
...
It’s no secret that AMD is and was their largest customer, but they have been rapidly declining. They went from 28% in 2019 to 21% in 2020. 2021 should be well under 20%. Qualcomm on the other hand is rapidly rising. They have gone from 8% in 2019 to 11% in 2020. In 2021, that should continue to rise and with the long-term agreement, they will likely move to become ~15% eventually.
...
- RF SOI – Specifically used for radio front end modules. Almost all cell phones and cell stations use this technology. It is used in low-noise amplifiers, RF switches, phased-array antennas, and control function integration for LTE, mmWave beamforming, and various 5G applications.
- Feature-Rich CMOS – Mixed technology for high volume and low cost. It includes Bipolar-CMOS-DMOS technologies required for power management, high-voltage triple-gate oxide for display, and embedded non-volatile memory for micro-controllers. One familiar use case is that the vast majority of NFC chips are manufactured by GlobalFoundries on this technology platform. Many power management ICs are also manufactured by them.
- FDX – Fully depleted silicon-on-insulator technologies are fantastic for cost effective but advanced and efficient designs. It should be very good at analog signal aswell. It is one of the most versatile platforms with features, such as ultra-low power and leakage cells/memory, RF and mmWave, eMRAM, and automotive qualification. It has designs in progress and manufacturing for IoT, wireless, 5G, automotive radar, and satellite communications applications.
- SiGe BiCMOS and GaN on Si – Optimized for power amplifier applications and very-high-frequency applications for optical and wireless networking, satellite communications and communications infrastructure. It is performance-competitive with more costly compound semiconductor technologies while taking full advantage of being integrated with conventional Si CMOS.
- FinFET – GlobalFoundries licensed most of their FinFET technology from Samsung, but they also have the IBM specific node. This works best for high-performance and power efficient SOCs, but not the most bleeding edge. It can be used anywhere from compute ASICs to automotive, IoT, transceivers, and networking. Currently Intel, Samsung, and TSMC operate successful FinFET nodes. SMIC currently still has fairly low yields and volume, but SemiAnalysis believes this technology lead will be severely diminished fairly soon as GlobalFoundries is not investing in smaller geometry FinFETs.
- Silicon Photonics – [We have written about their capabilities here in the past.](https://semianalysis.substack.com/p/globalfoundries-is-a-leading-edge) In short, optical communications and LiDAR are huge applications. Quantum computing is also an actively researched use case. The use cases of co-packaged optics and networking transceivers is a huge outlet for growth.
...
This spells trouble for real value of GlobalFoundries. Mubadala knows they cannot dump the entire company on the open market, so they will only IPO a small portion of the shares outstanding. We cannot be sure how much quite yet, but the filing makes it very clear that Mubadala will continue to be the majority owner of GlobalFoundries. SemiAnalysis believes Mubadala should have rolled the regulatory dice in trying to let Intel acquire the entire firm for a price that prevents them from losing a lot of money. Many investors will puke on this IPO and even if they get a decent valuation, they likely won’t be able to divest much of the firm.
