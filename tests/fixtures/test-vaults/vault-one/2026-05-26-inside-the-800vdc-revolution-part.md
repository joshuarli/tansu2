...
\\(I = \\frac{P}{V} = \\frac{600{,}000\\ \\mathrm{W}}{54\\ \\mathrm{V}} \\approx 11{,}111\\ \\mathrm{A} \\)

At 800 VDC:

\\(\\qquad I = \\frac{P}{V} = \\frac{600{,}000\\ \\mathrm{W}}{800\\ \\mathrm{V}} = 750\\ \\mathrm{A} \\)

That’s a 14.8× reduction in current. Now apply the loss equation. For the same conductor resistance R, the I² ratio implies:

\\(\\frac{I\_{54\\mathrm{V}}^{2}}{I\_{800\\mathrm{V}}^{2}} = \\frac{(11{,}111)^2}{(750)^2} \\approx 219\\times\\)
...
\\(I\_{48\\mathrm{V}} = \\frac{600{,}000}{48} = 12{,}500\\ \\mathrm{A} \\quad\\Rightarrow\\quad \\frac{(12{,}500)^2}{(750)^2} \\approx 278\\times\\)
