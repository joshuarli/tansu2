...
source: "https://newsletter.semianalysis.com/p/cerebras-faster-tokens-please?utm_source=post-email-title&publication_id=6349492&post_id=197494856&utm_campaign=email-post-title&isFreemail=true&r=ahgr8&triedRedirect=true&utm_medium=email"
author:
  - "[[Myron Xie]]"
...
It’s been nearly 5 years since Dylan [wrote a dedicated article about Cerebras in June of 2021](https://newsletter.semianalysis.com/p/cerebras-wafer-scale-hardware-crushes) for the newsletter. He shipped 4 articles in 2 days! They could be read inHow times have changed.
...
![](https://substackcdn.com/image/fetch/$s_!gjIo!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F964c659b-faf4-4d03-8536-cac66e03ce0d_2412x282.png)

Source: NVIDIA, Groq, and Cerebras
...
![](https://substackcdn.com/image/fetch/$s_!zbTY!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb10bccb9-414a-4810-851c-a34181c015e3_2396x340.png)
...
$\text{For } C_{M \times N} = A_{M \times K} \cdot B_{K \times N} \text{in single precision},\text{ with bytes per element } b : \\ FLOPs = 2 \cdot M \cdot N \cdot K \\ Bytes = \left(\right. M \cdot K + K \cdot N + M \cdot N \left.\right) \cdot b \\ \text{assuming all reads}/\text{writes go through DRAM} \\ AI = \frac{2 \cdot M \cdot N \cdot K}{\left(\right. M \cdot K + K \cdot N + M \cdot N \left.\right) \cdot b} FLOPs / byte \\ \text{For square } M = N = K = n : AI = \frac{2 n^{3}}{3 n^{2} b} = \frac{2}{3} \cdot \frac{n}{b} \\ \text{FP8 } \left(\right. b = 1 \left.\right) : AI \approx 0.67 n \\ \text{BF16 } \left(\right. b = 2 \left.\right) : AI \approx 0.33 n \\ \text{FP4 } \left(\right. b = 0.5 \left.\right) : AI \approx 1.33 n$
...
[Already a paid subscriber? **Switch accounts**](https://substack.com/sign-in?redirect=%2Fp%2Fcerebras-faster-tokens-please%3Futm_source%3Dpost-email-title%26publication_id%3D6349492%26post_id%3D197494856%26utm_campaign%3Demail-post-title%26isFreemail%3Dtrue%26r%3Dahgr8%26triedRedirect%3Dtrue%26utm_medium%3Demail&for_pub=semianalysis&change_user=true)